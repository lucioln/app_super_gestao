...
Route::prefix('/app')->middleware('autenticacao')->group(function(){
    ...
    Route::get ('/fornecedor/add','FornecedorController@adicionar')->name('app.fornecedor.adicionar');
    Route::post('/fornecedor/add','FornecedorController@gravar')->name('app.fornecedor.gravar');
    // Fim Fornecedores
